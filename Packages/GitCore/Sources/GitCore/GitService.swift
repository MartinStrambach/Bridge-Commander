...
public struct GitClient: Sendable {
	...
	public var mergeMaster: @Sendable (_ at: String, _ baseBranch: String) async throws -> GitMergeHelper.MergeResult
...
extension GitClient: DependencyKey {
	public static var liveValue: GitClient {
		GitClient(
			...
			mergeMaster: { at, baseBranch in
				try await GitMergeHelper.mergeMaster(at: at, baseBranch: baseBranch)
			},
			pull: { at in
