//
//  YouTrackService.swift
//  Bridge Commander
//
//  Service for fetching YouTrack issue information via API
//

import Foundation

struct YouTrackService {
    ...
    /// - Returns: A tuple containing (prUrl, androidCR, iosCR, androidReviewerName, iosReviewerName), any of which may be nil if not found
    static func fetchIssueDetails(for ticketId: String) async -> (prUrl: String?, androidCR: String?, iosCR: String?, androidReviewerName: String?, iosReviewerName: String?) {
